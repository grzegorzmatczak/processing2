...
namespace lbsp
{
	...
	#ifdef DEBUG
	Logger->debug("BackgroundSubtractorLOBSTER::BackgroundSubtractorLOBSTER() m_nBGSamples:{}", m_nBGSamples);
	Logger->debug("BackgroundSubtractorLOBSTER::BackgroundSubtractorLOBSTER() m_nRequiredBGSamples:{}", m_nRequiredBGSamples);
	Logger->debug("BackgroundSubtractorLOBSTER::BackgroundSubtractorLOBSTER() m_nDescDistThreshold:{}", m_nDescDistThreshold);
	#endif
	}
	...
	{
		#ifdef DEBUG
		Logger->debug("BackgroundSubtractorLOBSTER::initialize()");
		#endif
	...
	{
		#ifdef DEBUG
		Logger->debug("BackgroundSubtractorLOBSTER::refreshModel()");
		#endif
		// == refresh
	...
	{
		#ifdef DEBUG
		Logger->debug("BackgroundSubtractorLOBSTER::apply()");
		#endif
		CV_Assert(m_bInitialized);
		...
		{
			#ifdef DEBUG
			Logger->debug("BackgroundSubtractorLOBSTER::apply() m_nImgChannels == 1()");
			Logger->debug("BackgroundSubtractorLOBSTER::apply() m_nTotRelevantPxCount:{}", m_nTotRelevantPxCount);
			#endif
			for (size_t nModelIter = 0; nModelIter < m_nTotRelevantPxCount; ++nModelIter)
			{
				#ifdef DEBUG
				Logger->debug("BackgroundSubtractorLOBSTER::apply() nModelIter:{}", nModelIter);
				#endif
				const size_t nPxIter = m_aPxIdxLUT[nModelIter];
				const size_t nDescIter = nPxIter * 2;
				...
				#ifdef DEBUG
				Logger->debug("BackgroundSubtractorLOBSTER::apply() after goto");
				Logger->debug("BackgroundSubtractorLOBSTER::apply() nGoodSamplesCount:{}", nGoodSamplesCount);
				Logger->debug("BackgroundSubtractorLOBSTER::apply() m_nRequiredBGSamples:{}", m_nRequiredBGSamples);
				Logger->debug("BackgroundSubtractorLOBSTER::apply() nLearningRate:{}", nLearningRate);
				#endif
				...
				else
				{
					...
					{
						#ifdef DEBUG
						Logger->debug("BackgroundSubtractorLOBSTER::apply() rand1:");
						#endif
						...
						#ifdef DEBUG
						Logger->debug("BackgroundSubtractorLOBSTER::apply() computeGrayscaleDescriptor:");
						#endif
					...
					{
						#ifdef DEBUG
						Logger->debug("BackgroundSubtractorLOBSTER::apply() rand2:");
						#endif
						int nSampleImgCoord_Y, nSampleImgCoord_X;
		...
		{ //m_nImgChannels==3
			#ifdef DEBUG
			Logger->debug("BackgroundSubtractorLOBSTER::apply() m_nImgChannels==3");
			#endif
		...
		#ifdef DEBUG
		Logger->debug("BackgroundSubtractorLOBSTER::apply() medianBlur");
		#endif
